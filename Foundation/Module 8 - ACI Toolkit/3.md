...
![Figure](/posts/files/aci/s1.png)

![Figure](/posts/files/aci/s2.png)
...
```
    ...
    cd samples
    echo LOGIN='ciscolive' > credentials.py
    echo PASSWORD = 'DevNet123' >> credentials.py
    echo IPADDR = '10.10.20.57' >> credentials.py
...
![Figure](/posts/files/aci/s3.png)

* The output should be similar to the following:

![Figure](/posts/files/aci/s4.png)
